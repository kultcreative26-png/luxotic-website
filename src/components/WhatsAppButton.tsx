    ...
    <div className="fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      >
        <div className="flex flex-col text-left">
          <div className="text-[11px] font-semibold tracking-wide flex items-center gap-1.5 text-white">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping inline-block" />
            <span>Chat on WhatsApp</span>
          </div>
          <span className="text-[9px] text-emerald-400 font-medium tracking-wider uppercase">
            Online • Quick Property Response
          </span>
        </div>
      </div>
